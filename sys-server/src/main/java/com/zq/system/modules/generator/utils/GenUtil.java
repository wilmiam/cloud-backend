...
public class GenUtil {
    ...
    private static Map<String, Object> getGenMap(List<ColumnInfo> columnInfos, GenConfig genConfig) {
        ...
        // 大写开头的类名
        String className = CamelNameUtils.toCapitalizeCamelCase(genConfig.getTableName());
        // 小写开头的类名
        String changeClassName = CamelNameUtils.toCamelCase(genConfig.getTableName());
        // 判断是否去除表前缀
        if (StringUtils.isNotEmpty(genConfig.getPrefix())) {
            className = CamelNameUtils.toCapitalizeCamelCase(StrUtil.removePrefix(genConfig.getTableName(), genConfig.getPrefix()));
            changeClassName = CamelNameUtils.toCamelCase(StrUtil.removePrefix(genConfig.getTableName(), genConfig.getPrefix()));
        ...
        for (ColumnInfo column : columnInfos) {
            ...
            // 小写开头的字段名
            String changeColumnName = CamelNameUtils.toCamelCase(column.getColumnName());
            // 大写开头的字段名
            String capitalColumnName = CamelNameUtils.toCapitalizeCamelCase(column.getColumnName());
